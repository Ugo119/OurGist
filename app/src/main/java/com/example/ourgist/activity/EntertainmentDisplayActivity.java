...
import com.example.ourgist.controller.EntertainmentDisplayFragment;
import com.example.ourgist.controller.SportsFragment;

public class EntertainmentDisplayActivity extends SingleFragmentActivity {
    ...
    protected Fragment createFragment() {
        ...
        newsCollectionPagerAdapter = new NewsCollectionPagerAdapter(this, fm);
         ...
         return new EntertainmentDisplayFragment();
